...
local equipSoundId = "rbxassetid://171140306"
local reloadSoundId = "rbxassetid://174295321"
local shootSoundId = "rbxassetid://10209859"
...
remoteEvent.OnServerEvent:Connect(function(player, data)
    ...
    local fireSound = equippedTool:FindFirstChild("Fire")
    if fireSound then
        fireSound:Play()
    end
end)